...
class PhysicsBody : public Entity {             //"physicsbody is an entity, inheriting everything public from it" 
    ...
    public:
        ...
        void Update(float dt) override;       //declared here, defined in PhysicsBody.cpp
                                              //dt is unit time, at 60FPS dt becomes 0.016 seconds, thats how often the frame updates. 
